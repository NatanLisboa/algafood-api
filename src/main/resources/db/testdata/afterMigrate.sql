...
values (
  ...
  'READ,WRITE', 'password,authorization_code', 'http://localhost:8080,http://localhost:8080/swagger-ui/oauth2-redirect.html',
...
values (
  'invoicing', null, '$2a$12$yKVluj7GLkD/oE5kDWaXHOtm5DNKU9ffCR7/FUumLFGNKDCXPIp62',
